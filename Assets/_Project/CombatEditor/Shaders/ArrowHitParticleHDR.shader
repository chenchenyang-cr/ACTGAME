// Project-owned HDR version of CommonParticleOneShot. Preserves UV animation, masks and particle custom data.
// Made with Amplify Shader Editor v1.9.3.2
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "CombatEditor/ArrowHitParticleHDR"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float3 Color = ( IN.ase_color * tex2DNode73 * max(0.0, texCoord120.x) ).rgb * _HdrColor.rgb * max(0.0, _HdrIntensity);
