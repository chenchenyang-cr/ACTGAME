...
namespace CombatEditor
{
    public partial class CombatEditor : EditorWindow
    {
        ...
        public void PaintTrack()
        {
            ...
            {
                var track = AnimEventTracks[i];
                if (track == null || track.eve == null || track.eve.Obj == null)
                {
                    continue;
                }
                ...
                PaintTrackBG(i);
                //Draggable
                if (track.eve.Obj.GetEventTimeType() == AbilityEventObj.EventTimeType.EventRange)
                {
                    PaintRangeRect(i);
                }

                else if (track.eve.Obj.GetEventTimeType() == AbilityEventObj.EventTimeType.EventTime)
                {
                    PaintPointRect(i);
                }

                else if (track.eve.Obj.GetEventTimeType() == AbilityEventObj.EventTimeType.EventMultiRange)
                {
        ...
        public void PaintPointRect(int i)
        {
            ...
            Color trackColor = GetTrackTintColor(AnimEventTracks[i].eve);
        ...
        private Color GetTrackTintColor(AbilityEvent abilityEvent)
        {
            return Color.white;
        }

        private string GetTrackStyleName(AbilityEvent abilityEvent)
        {
            ...
            if (abilityEvent?.Obj is AbilityEventObj_MethodContinuous || abilityEvent?.Obj is AbilityEventObj_Method)
            {
                return "flow node 1";
            }
