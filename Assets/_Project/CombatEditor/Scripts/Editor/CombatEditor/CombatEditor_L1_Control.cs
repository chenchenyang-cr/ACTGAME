...
namespace CombatEditor
{
    public partial class CombatEditor
    {
        ...
        public void OnRenameAbilityObjToClipName(AbilityScriptableObject data)
        {
            ...
            bool wasSelected = SelectedAbilityObj == data;

            string targetName = data.Clip.name;
            ...
            string renameError = AssetDatabase.RenameAsset(assetPath, targetName);
            if (!string.IsNullOrWhiteSpace(renameError))
            {
                Debug.LogWarning($"Rename ability asset failed: {renameError}");
                return;
            }

            string renamedAssetPath = AssetDatabase.GetAssetPath(data);
            AbilityScriptableObject renamedAsset = AssetDatabase.LoadAssetAtPath<AbilityScriptableObject>(renamedAssetPath);
            ...
            if (wasSelected || SelectedAbilityObj == null)
            {
